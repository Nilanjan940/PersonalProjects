...
<head>
    ...
    <title>Delete Supplier - InduStock</title>
            ...
            <div class="container py-5">
                ...
                <div class="confirmation-panel">
                    <div class="alert alert-danger">
                        <h4><i class="fas fa-exclamation-triangle me-2"></i>Warning: Permanent Action</h4>
                        <p class="mb-0">You are about to permanently delete this supplier from the system.</p>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <ul class="impact-list">
                            ...
                            <li>
                                ...
                                Transaction history will be preserved but marked "Supplier Deleted"
                            </li>
                        </ul>
                    </div>
