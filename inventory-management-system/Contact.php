                ...
                <div class="row">
                    <div class="col-lg-12 col-offset-2">
                        <div class="page-header">
                            ...
                            <h2><ion-icon name="mail-outline"></ion-icon> Contact Support</h2>
                        ...
                        <div class="form-container">
                            <form method="POST" action="process_feedback.php" enctype="multipart/form-data" id="feedbackForm">
                                <div class="mb-3">
                                    <label for="user_email" class="form-label">Email Address</label>
                                    <input type="email" name="user_email" id="user_email" class="form-control" 
                                           required placeholder="Enter your email address" maxlength="50">
                                </div>

                                <div class="mb-3">
                                    <label for="feedback" class="form-label">Feedback Message</label>
                                    <textarea name="feedback" id="feedback" rows="4" class="form-control" 
                                              required placeholder="Enter your feedback message"></textarea>
                                </div>
                                ...
                                <div class="d-flex gap-2">
                                    <button type="submit" class="btn btn-primary">
                                        <ion-icon name="paper-plane-outline"></ion-icon> Submit Feedback
                                    </button>
