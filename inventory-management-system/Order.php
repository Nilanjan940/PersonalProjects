...
<li class="navList">
    ...
    <section class="dashboard">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
            <a href="Deliver_order.php" class="btn btn-primary" style="margin-top:18px;">Transfer Product</a>
            </div>
        </div>
</form>
<form class="form-inline" method="POST" id="orderForm" action="orderpdf.php" onsubmit="return validateLocation();">
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-2">
            <input type="submit" value="Print" name="order" style="margin-top:18px;" class="btn btn-success w-100">
        </div>
    </div>
</form>

<h3 style="margin-top:20px;">Transfered Product</h3>
<div class="row" id="lightgallery" >
    ...
    $(document).ready(function () {
        var table = $('#transferTable').DataTable({
            ...
            columnDefs: [
                { responsivePriority: 1, targets: 0 }, // Tracking ID
                { responsivePriority: 2, targets: 2 }, // Name
                { responsivePriority: 3, targets: 5 }, // Location
                { responsivePriority: 4, targets: 6 }, // Date
                { responsivePriority: 5, targets: 1 }, // Product ID
                { responsivePriority: 6, targets: 3 }, // Qty
                { responsivePriority: 7, targets: 4 }  // Price
            ]
        });
