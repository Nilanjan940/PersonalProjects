                        ...
                        <tbody>
                            ...
                            if ($user_info_query) {
                                while ($user_data = mysqli_fetch_assoc($user_info_query)) {
                                    ...
                                    echo "<td>
                                            <a href='edit_account.php?editid={$user_data['username']}' class='btn btn-warning btn-sm'>Change password</a>
                                            <a href='deleteaccount.php?username={$user_data['username']}' class='btn btn-danger btn-sm'>Delete account</a>
                                        </td>";
                                    echo "</tr>";
                                }
                            } else {
